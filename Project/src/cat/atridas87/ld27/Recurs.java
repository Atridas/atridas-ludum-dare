...
public enum Recurs {
	...
	MAGATZEM(3,1, Type.EDIFICI),
	TEMPLE(4,1, Type.EDIFICI),
	CASA(5,1, Type.EDIFICI),
	CABANA_BRUIXA(7,1, Type.EDIFICI),
	TEATRE(0,2, Type.EDIFICI),
	BANC(1,2, Type.EDIFICI),
	INSTITUT(2,2, Type.EDIFICI),
	BAR(3,2, Type.EDIFICI),
	MOLI_DE_VENT(4,2, Type.EDIFICI),
	FLECA(5,2, Type.EDIFICI),
	MERCAT(6,2, Type.EDIFICI),
	CONSTRUCTORA(6,1, Type.EDIFICI),
